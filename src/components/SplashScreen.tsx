  ...
  return (
    <div className={`splash-screen ${fadeOut ? 'opacity-0' : 'opacity-100'} transition-opacity duration-500`}>
      ...
      <div className="relative z-10 flex flex-col items-center backdrop-blur-sm">
        ...
        {showTerminal && (
          <div className="mt-4 w-64 h-32 bg-indigo-900/60 border border-indigo-400/50 rounded-md p-2 overflow-hidden">
        ...
        <div className="mt-4 text-indigo-300 animate-pulse text-sm font-mono tracking-wider">SYSTEM LOADING...</div>
      </div>
    </div>
  );
};
